...
__global__ void trilinear_bw_kernel(
    ...
    dL_dfeats[n][0][f] = (1-u)*dL_dfeat_interp[n][f]*a;
    dL_dfeats[n][1][f] = (1-u)*dL_dfeat_interp[n][f]*b;
    dL_dfeats[n][2][f] = (1-u)*dL_dfeat_interp[n][f]*c;
    dL_dfeats[n][3][f] = (1-u)*dL_dfeat_interp[n][f]*d;
    dL_dfeats[n][4][f] = u*dL_dfeat_interp[n][f]*a;
    dL_dfeats[n][5][f] = u*dL_dfeat_interp[n][f]*b;
    dL_dfeats[n][6][f] = u*dL_dfeat_interp[n][f]*c;
    dL_dfeats[n][7][f] = u*dL_dfeat_interp[n][f]*d;
...
torch::Tensor trilinear_bw_cu(
    ...
    AT_DISPATCH_FLOATING_TYPES(feats.type(), "trilinear_bw_cuda", 
    ([&] {
