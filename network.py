# this is a example of a network with numpy   
# it is used to help me understand the backpropagation algorithm
# reference url:https://zhuanlan.zhihu.com/p/67682601
